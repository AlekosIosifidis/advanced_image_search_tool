...
## Easy Install
In case you don't wish to download the required models individually or if some models are no longer available, you can simply install #SearchTool1.zip #SearchTool2.zip and #SearchTool3.zip
